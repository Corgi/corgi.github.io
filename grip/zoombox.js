...
<img class='zoombox-image slide' src='https://corgi.github.io/grip/load.svg'>
...
<img class='zoombox-close zoombox-controls' src='https://corgi.github.io/grip/close.png'>
<img class='zoombox-next zoombox-controls' src='https://corgi.github.io/grip/next.png'>
<img class='zoombox-prev zoombox-controls' src='https://corgi.github.io/grip/prev.png'>
<img class='zoombox-play zoombox-controls' src='https://corgi.github.io/grip/play.png'>
<img class='zoombox-zoom-in zoombox-controls' src='https://corgi.github.io/grip/zoom-in.svg'>
<img class='zoombox-zoom-out zoombox-controls' src='https://corgi.github.io/grip/zoom-out.svg'>
...
class zoomboxImages {
	...
	putImage(){
				...
				this.zoomboxImage.src = `https://corgi.github.io/grip/load.svg`;
	...
	checkPlay(isplay){
		...
		if (isplay) {
			this.isplaying = false;
			this.zoomboxPlay.src = `https://corgi.github.io/grip/play.png`;
			clearTimeout(this.slideTimeOut);
		} else {
			this.isplaying = true;
			this.zoomboxPlay.src = `https://corgi.github.io/grip/pause.png`;
			this.slideShow();	
		}
	}
	...
	nextPrevImage(imageIndex){
		...
		this.zoomboxImage.src = `https://corgi.github.io/grip/load.svg`; //show loading icon untill image loads up
	...
	groupName.forEach( (group)=>{
		...
		images.forEach( (img,index)=>{
			img.onclick = ()=>{ 
				...
				console.log('execute');
				zoombox.execute();
				document.querySelector('.zoombox-close').src = `https://corgi.github.io/grip/close.png`;
				document.querySelector('.zoombox-zoom-in').src = `https://corgi.github.io/grip/zoom-in.svg`;
				document.querySelector('.zoombox-zoom-out').src = `https://corgi.github.io/grip/zoom-out.svg`;
				document.querySelector('.zoombox-next').src = `https://corgi.github.io/grip/next.png`;
				document.querySelector('.zoombox-prev').src = `https://corgi.github.io/grip/prev.png`;
				document.querySelector('.zoombox-play').src = `https://corgi.github.io/grip/play.png`;
