    ...
    B = (function (D) {
      var u = 0 === (window ? window.location.href : '').indexOf(l(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(l(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== D.indexOf(l(49, 50, 55, 46, 48, 32, 48, 46, 49)),
        F = [
          ...
          l(99, 111, 100, 101, 112, 101, 110, 46, 112, 108, 117, 109, 98, 105, 110, 103),
          ...
          l(116, 104, 101, 109, 101, 102, 111, 114, 101, 115, 116, 46, 110, 101, 116),
          ...
          l(109, 111, 116, 105, 111, 110, 116, 114, 105, 99, 107, 115, 46, 99, 111, 109),
          l(115, 116, 97, 99, 107, 111, 118, 101, 114, 102, 108, 111, 119, 46, 99, 111, 109),
          l(115, 116, 97, 99, 107, 101, 120, 99, 104, 97, 110, 103, 101, 46, 99, 111, 109),
          l(106, 115, 102, 105, 100, 100, 108, 101, 46, 110, 101, 116),
          l(119, 101, 98, 102, 108, 111, 119, 46, 105, 111),
          l(99, 111, 114, 103, 105, 98, 114, 97, 100, 98, 117, 114, 121, 46, 99, 111, 109),
      ...
      for (
        setTimeout(function () {
          window &&
            ...
            (console.log(l(37, 99, 87, 97, 114, 110, 105, 110, 103), l(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
            console.log(
              l(65, 32, 116, 114, 105, 97, 108, 32, 118, 101, 114, 115, 105, 111, 110, 32, 111, 102, 32) +
                E +
                l(
                  32,
                  105,
    ...
    f = {
      ...
      init: function init(D, u, F) {
        if ((a || t(), (this.prop = 'innerHTML' in D ? 'innerHTML' : 'textContent' in D ? 'textContent' : 0), this.prop)) {
          ...
          return (
            ...
            (r.original = emojiSafeSplit(getText(D).replace(A, ' ').split('&nbsp;').join(''), C, l)),
            ...
            (r.lengthDif = (n ? r.text.length : r.text.join(C).length) - r.length),
      ...
      render: function render(D, u) {
        var F,
          ...
          P = f._time,
          I = P - p;
        c && (f._from && (P = f._dur - P), (D = 0 === P ? 0 : P < c ? 1e-6 : P === f._dur ? 1 : f._ease((P - c) / (f._dur - c)))),
          D < 0 ? (D = 0) : 1 < D && (D = 1),
          _ && (D = 1 - D),
          (F = ~~(D * H + 0.5)),
          (E = D ? ((L < I || I < -L) && ((u.setIndex = g = (g + ((19 * Math.random()) | 0)) % 20), (u.chars = m.sets[g]), (u.prevScrambleTime += I)), d) : M.join(h)),
          (s = f._from ? D : 1 - D),
          ...
          (E = _
            ? 1 !== D || (!f._from && 'isFromStart' !== f.data)
              ? ((i = A.slice(F).join(h)),
                (e = S
                  ? emojiSafeSplit(E)
                      .slice(0, (o - (x ? emojiSafeSplit(i) : i).length + 0.5) | 0)
                      .join('')
                  : E.substr(0, (o - (x ? emojiSafeSplit(i) : i).length + 0.5) | 0)),
                i)
              : ((e = ''), M.join(h))
          ...
          (i = O ? ((t = (l = _ ? T : b) && 0 != F) ? "<span class='" + l + "'>" : '') + e + (t ? '</span>' : '') + ((n = (r = _ ? b : T) && F !== H) ? "<span class='" + r + "'>" : '') + h + E + (n ? '</span>' : '') : e + h + E),
          (a[B] = '&nbsp;' === y && ~i.indexOf('  ') ? i.split('  ').join('&nbsp;&nbsp;') : i);
      },
    };
